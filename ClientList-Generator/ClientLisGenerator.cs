...
namespace ClientList_Generator
{
    public class ClientLisGenerator
    {
        ...
        public void clientListGenerator()
        {
            ...
            var jsonPath = @$"C:\Users\Vartotojas\source\repos\Lesson-15\OrdersSistem(nr.4)\OrdersSistem(nr.4)\{jsonFilename}";
            File.WriteAllText(jsonPath, jsonString);

            var report = "client.txt";
            var path = @$"C:\Users\Vartotojas\source\repos\Lesson-15\OrdersSistem(nr.4)\OrdersSistem(nr.4)\{report}";
